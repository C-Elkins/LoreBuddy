...
function LoreBuddyJournal.new(engine, personality, state, onOpenSettings)
    ...
    local brandHeader = frame:CreateTexture(nil, "ARTWORK")
    brandHeader:SetSize(250, 84)
    brandHeader:SetPoint("TOP", 0, -4)
    Theme.setTexture(brandHeader, Theme.media.header)

    local title = frame:CreateFontString(nil, "OVERLAY", Theme.fonts.title)
    title:SetPoint("TOP", brandHeader, "BOTTOM", 0, 2)
    title:SetText("Lore Journal")
    ...
    settingsButton:SetSize(26, 26)
    settingsButton:SetPoint("TOPLEFT", 8, -98)
    local settingsIcon = settingsButton:CreateTexture(nil, "ARTWORK")
    settingsIcon:SetSize(16, 16)
    settingsIcon:SetPoint("CENTER")
    Theme.setTexture(settingsIcon, "Interface/Icons/Trade_Engineering")
